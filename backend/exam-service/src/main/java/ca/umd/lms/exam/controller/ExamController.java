...
@RestController
@RequestMapping("/exams")///These annotations define the class as a REST controller, and all the request mappings within this controller are relative to the base path "/exams."
